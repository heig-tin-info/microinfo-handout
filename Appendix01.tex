...
La multiplication en colonnes classique fonctionne en complément à 2 mais elle est différente dans le cas ou le multiplicateur est positif ou négatif. Si il est négatif, il faudra faire le complément à 2 à la fin du calcul pour retrouver le résultat correct. Cette différence de temps de calcul en fonction du signe est gênante mais peut être évitée grâce à l'algorithme de Booth (1950) \cite{booth}. L'algorithme consiste en la transformation suivante:
