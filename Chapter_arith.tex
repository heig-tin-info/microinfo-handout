...
\item Si le multiplicateur est négatif alors il faut calculer sans le signe puis effectuer une conversion
\end{enumerate}
On peut résoudre ces problèmes en utilisant l'\textbf{algorithme de Booth} (voir annexe \ref{ch:algebra}). 
