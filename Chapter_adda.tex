...
Aujourd'hui, les opérations complexes de traitement de signal sont exécutées par des circuits numériques.
...
Le terme proportionnel est abusif dans la mesure où la fonction de transfert $N = f(V_{in})$ est une fonction en escalier, comme illustré à la figure
