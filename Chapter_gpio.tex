...
{\fontfamily{qcr}\selectfont
//fonction désirée:
TEST\_ BIT0 = REG ? BIT0 avec par exemple REG = 00000011 et BIT0 = 00000001\\
//essai avec OU:
TEST\_ BIT0 = REG | BIT0  //TEST\_ BIT0 = 00000011 FAUX
//et si REG = 00000010
TEST\_ BIT0 = REG | BIT0  //TEST\_ BIT0 = 00000011 FAUX\\
//Il est clair que ça ne marche pas avec OU essayons avec ET:
TEST\_ BIT0 = REG \& BIT0  //TEST\_ BIT0 = 00000001 JUSTE
//et si REG = 00000010
TEST\_ BIT0 = REG \& BIT0  //TEST\_ BIT0 = 00000000 JUSTE
}\\
