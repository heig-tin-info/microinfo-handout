...
Dans cette exemple la table des vecteurs est placée à l'adresse FFFF, c'est à dire en haut d'un espace mémoire de 16 bits (65536 adresses). Les deux premières colonnes sont des constantes et la troisième est remplie lors de la compilation.
...
Les interruptions externes proviennent des périphériques, on les appelles aussi interruptions matérielles à l'opposé des interruptions logicielles qui proviennent du programme lui même.
...
Pour une interruption depuis une interface série, il nous faut un vecteur d'interruption approprié, USCI\_A0\_VECTOR par exemple:
