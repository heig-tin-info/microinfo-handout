% -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
% COURS MUI
% Bertrand Hochet  Pierre Favrat  Claude Evequoz
...
\usepackage{hyperref}
%\usepackage{tikz}
\hypersetup{pdftex, colorlinks=true, linkcolor=blue, citecolor=blue, filecolor=blue, urlcolor=blue, pdftitle=Systmes lectronique II, pdfauthor=linuxmint , pdfsubject=Chapitre 01 - Introduction, pdfkeywords=}
\usepackage{fancyhdr}
...
\author{Cours créé par Claude Evequoz, Pierre Favrat et Bertrand Hochet\\ \\  HEIG-VD}
...
\fancyfoot[RE,LO]{HEIG-VD / Claude Evequoz, Pierre Favrat et Bertrand Hochet}
\fancyfoot[LE,RO]{Page \thepage}

% redfini le style pour plain (1re page des chapitres)

\fancypagestyle{plain}{%
  \fancyfoot[RE,LO]{HEIG-VD / MUI/ Claude Evequoz, Pierre Favrat et Bertrand Hochet}
  \fancyfoot[LE,RO]{Page \thepage}
  \fancyhead[LE,RO]{}
 \renewcommand{\headrulewidth}{1pt}
  \renewcommand{\footrulewidth}{1pt}
...
\end{tabular}
\begin{center}
\textbf{Cours créé par Claude Evequoz, Pierre Favrat et Bertrand Hochet}
\end{center}
\begin{center}
\textbf{HEIG-VD}
\textbf{février 2014} \\
...
% -----------------------------------------------------------------------
% numÃ©rotation, taille de la zone utilisable, entÃªte et bas de page
...
&\\
Professeur HES & Claude Evequoz\\
Email & claude.evequoz@heig-vd.ch\\
Téléphone & 024 557 27 68 \\
Bureau & Y-Parc, CH-1400 Yverdon-les-Bains
\\
\-
\\
Professeur HES & Pierre Favrat\\
...
\-
\\
Professeur HES & Bertrand Hochet\\
...
\renewcommand{\headrulewidth}{1pt}
\renewcommand{\footrulewidth}{1pt}
\fancyfoot[RE,LO]{HEIG-VD  / Claude Evequoz Pierre Favrat Bertrand Hochet}
\fancyfoot[LE,RO]{Page \thepage\ sur \pageref{LastPage}}

% redfini le style pour plain (1re page des chapitres)

\fancypagestyle{plain}{%
  \fancyfoot[RE,LO]{HEIG-VD / MUI/ Claude Evequoz Pierre Favrat Bertrand Hochet}
  \fancyfoot[LE,RO]{Page \thepage\ sur \pageref{LastPage}}
  \fancyhead[LE,RO]{}
 \renewcommand{\headrulewidth}{1pt}
  \renewcommand{\footrulewidth}{1pt}
...
\pagenumbering{arabic} \setcounter{page}{1}
\input{./Chap01/Chapter1.tex} 
%
%\pagenumbering{arabic} \setcounter{page}{1}
\input{./Chap02/Chapter02.tex} 

%\pagenumbering{arabic} \setcounter{page}{1}
\input{./Chap03/Chapter03.tex}    %%  
...
\input{./Appendix01/Appendix01.tex}   %
