...
\item etc...
\end{itemize}
Pour cette raison, cette interface est souvent appelée \it sonde programmation et debug \rm ou \it sonde de debug \rm ou encore \it sonde JTAG\rm.
